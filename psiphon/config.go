...
const (
	...
	PsiphonDataDirectoryName = "ca.vaipnpsi.VaipnTunnel.tunnel-core"
...
type Config struct {
	...
	// https://github.com/payske-dev/vaipn-psi-tunnel-core/tree/master/psiphon/upstreamproxy
...
func (n *loggingNetworkIDGetter) GetNetworkID() string {
	...
	// See: https://godoc.org/github.com/payske-dev/vaipn-psi-tunnel-core/psiphon#NetworkIDGetter
