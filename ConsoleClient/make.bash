...
if [ ! -f make.bash ]; then
  echo "make.bash must be run from $GOPATH/src/github.com/payske-dev/vaipn-psi-tunnel-core/ConsoleClient"
  exit 1
fi
...
EXE_BASENAME="vaipn-psi-tunnel-core"
...
build_for_windows () {
  ...
  ## We are finding that UPXing the full Windows Psiphon client produces better results if vaipn-psi-tunnel-core.exe is not already UPX'd.
