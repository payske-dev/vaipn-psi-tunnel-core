...
This app tunnels WKWebView traffic by proxying requests through the local Psiphon proxies created by [VaipnTunnel](https://github.com/payske-dev/vaipn-psi-tunnel-core/tree/master/MobileLibrary/iOS/VaipnTunnel).
...
***This is a description of a workaround used in the [Psiphon Browser iOS app](https://github.com/payske-inc/endless) and not of what is implemented in TunneledWebView.
...
#### Background
In [PsiphonBrowser](https://github.com/payske-inc/endless) we have implemented a workaround for audio and video being 
fetched out of process.

[VaipnTunnel's](https://github.com/payske-dev/vaipn-psi-tunnel-core/tree/master/MobileLibrary/iOS/VaipnTunnel/VaipnTunnel)
HTTP Proxy also offers a ["URL proxy (reverse proxy)"](https://github.com/payske-dev/vaipn-psi-tunnel-core/blob/631099d086c7c554a590b0cb76766be6dce94ef9/psiphon/httpProxy.go#L45-L70) 
...
* This is done by [injecting javascript](https://github.com/payske-inc/endless/blob/b0c33b4bbd917467a849ad8c51a225c2d4dab260/Endless/Resources/injected.js#L379-L408) 
into the HTML [as it is being loaded](https://github.com/payske-inc/endless/blob/b0c33b4bbd917467a849ad8c51a225c2d4dab260/External/JiveAuthenticatingHTTPProtocol/JAHPAuthenticatingHTTPProtocol.m#L1274-L1280) 
which [rewrites media URLs to use the URL proxy (reverse proxy)](https://github.com/payske-inc/endless/blob/b0c33b4bbd917467a849ad8c51a225c2d4dab260/Endless/Resources/injected.js#L319-L377).
...
CSP](https://github.com/payske-inc/endless/blob/b0c33b4bbd917467a849ad8c51a225c2d4dab260/External/JiveAuthenticatingHTTPProtocol/JAHPAuthenticatingHTTPProtocol.m#L1184-L1228) 
to include a nonce generated for our injected javascript, which is [included in the script tag](https://github.com/payske-inc/endless/blob/b0c33b4bbd917467a849ad8c51a225c2d4dab260/External/JiveAuthenticatingHTTPProtocol/JAHPAuthenticatingHTTPProtocol.m#L1276).

*Requests to localhost (`127.0.0.1`) should be [excluded from being proxied](https://github.com/payske-dev/vaipn-psi-tunnel-core/blob/master/MobileLibrary/iOS/SampleApps/TunneledWebView/External/JiveAuthenticatingHTTPProtocol/JAHPAuthenticatingHTTPProtocol.m#L283-L287) so the system does not attempt to proxy loading the rewritten URLs. They will be correctly proxied through VaipnTunnel's reverse proxy.*
