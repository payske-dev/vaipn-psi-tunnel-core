...
NSErrorDomain _Nonnull const VaipnTunnelErrorDomain = @"com.psiphon3.ios.VaipnTunnelErrorDomain";
...
@interface VaipnTunnel () <GoPsiPsiphonProvider>
...
+ (NSURL*)defaultDataRootDirectoryWithError:(NSError**)err {
    *err = nil;
    ...
    return [libraryURL URLByAppendingPathComponent:@"com.psiphon3.ios.VaipnTunnel.tunnel-core"
                                       isDirectory:YES];
}
...
- (NSString * _Nullable)getConfig:(BOOL * _Nonnull)usingNoticeFiles
    ...
    *outError = nil;
    ...
    NSError *err;
    NSString *psiphonConfig = [VaipnTunnel buildPsiphonConfig:configObject
...
- (NSString *)getDNSServersAsString {
    ...
    if (self->tunnelWholeDevice == TRUE && atomic_load(&self->useInitialDNS)) {
        ...
        // Alternate DNS servers may be provided by vaipn-psi-tunnel-core config
...
- (void)startSendFeedback:(NSString * _Nonnull)feedbackJson
    ...
    dispatch_async(self->workQueue, ^{
        ...
        NSString *psiphonConfig = [VaipnTunnel buildPsiphonConfig:feedbackConfigJson
